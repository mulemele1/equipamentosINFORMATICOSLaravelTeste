            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>LISTA DE LOCAL</h4>
                        <h6>GERENCIAR LOCAL</h6>
                    </div>
                    <div class="page-btn">
                        <a href="{{url('create_local')}}" class="btn btn-added">
                            <img src="assets/img/icons/plus.svg" alt="Add new Equipment">
                            Adicionar novo locals
                        </a>
                    </div>
                </div>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nome da local do equipamentos</th>
                                        <th>Ações</th>
                                    </tr>
                                </thead>
                                <tbody>
