                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="{{url('view_maquina')}}">Lista de Equipamento</a></li>
                                <li><a href="{{url('create_maquina')}}">Adicionar Novo Equipamento</a></li>
                                <li><a href="{{url('list_marca')}}">Lista das Marcas</a></li>
                                <li><a href="{{url('create_marca')}}">Adicionar Nova Marca</a></li>
                                <li><a href="{{url('list_local')}}">Lista de Local</a></li>
                                <li><a href="{{url('create_local')}}">Adicionar Novo Local</a></li>
                                <li><a href="{{url('list_estado')}}">Lista Estado</a></li>
                                <li><a href="{{url('create_estado')}}">Adicionar Novo estado</a></li>
                                <li><a href="{{url('list_sistema')}}">Listar Sistema Operacional</a></li>
                                <li><a href="{{url('create_sistema')}}">Adicionar Sistema Operacional</a></li>
                            </ul>
