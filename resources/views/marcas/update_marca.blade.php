            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>EDITAR MARCA DO EQUIPAMENTO</h4>
                        <h6>ACTUALIZAR MARCA DO EQUIPAMENTO</h6>
                    </div>
                </div>

                <form action="{{url('edit_marca', $data->id)}}" method="Post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="{{ $data->nome_marca }}">
                                    </div>
                                </div>
