        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        <a href="{{url('create_marca')}}" class="btn btn-added">
                            <img src="assets/img/icons/plus.svg" alt="Add new Equipment">
                            Adicionar novo Marcas
                        </a>
                    </div>
                </div>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nome da marca do equipamentos</th>
                                        <th>Ações</th>
                                    </tr>
                                </thead>
                                <tbody>
