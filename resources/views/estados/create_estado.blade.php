    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                ...
                <h6>CRIAR NOVA ESTADO</h6>
            </div>
        </div>

        <form action="{{url('add_estado')}}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label>Nome da estado do equipamento:</label>
                                <input type="text" name="nome_estado" id="nome_estado" required>
                            </div>
                        </div>
