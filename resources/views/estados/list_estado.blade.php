            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>LISTA DE ESTADOS DOS EQUIPAMENTOS</h4>
                        <h6>GERENCIAR ESTADOS DOS EQUIPAMENTOS</h6>
                    </div>
                    <div class="page-btn">
                        <a href="{{url('create_estado')}}" class="btn btn-added">
                            <img src="assets/img/icons/plus.svg" alt="Add new Equipment">
                            Adicionar novo estado do equipamento
                        </a>
                    </div>
                </div>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nome do estado do equipamentos</th>
                                        <th>Ações</th>
                                    </tr>
                                </thead>
                                <tbody>
