    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>ADICIONAR SISTEMA OPERACIONAL</h4>
                <h6>CRIAR NOVO SISTEMA OPERACIONAL</h6>
            </div>
        </div>

        <form action="{{url('add_sistema')}}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="nome_sistema" id="nome_sistema" required>
                            </div>
                        </div>
