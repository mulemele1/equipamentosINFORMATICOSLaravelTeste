            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>EDITAR ESTADO DO EQUIPAMENTO</h4>
                        <h6>ACTUALIZAR ESTADOS DOS EQUIPAMENTOS</h6>
                    </div>
                </div>

                <form action="{{url('edit_estado', $data->id)}}" method="Post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <label>Nome do estado do Equipamento</label>
                                        <input type="text" name="title" value="{{ $data->nome_estado }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <a href="{{url('list_estado')}}" class="btn btn-secondary">Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
