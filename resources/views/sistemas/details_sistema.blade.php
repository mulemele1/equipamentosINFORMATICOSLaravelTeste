            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Detalhes da Sistema Equipamento</h4>
                        <h6>Todo Detalhe da Sistema do Equipamento</h6>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="productdetails">
                                    <ul class="product-bar">
                                        <li>
                                            <h4>Nome da sistema </h4>
                                            <h6><input type="text" name="title" value="{{ $data->nome_sistema }}"
