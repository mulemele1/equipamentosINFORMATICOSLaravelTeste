            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>EDITAR SISTEMAS OPERACIONAIS</h4>
                        <h6>ACTUALIZAR SISTEMAS OPERACIONAL</h6>
                    </div>
                </div>

                <form action="{{url('edit_sistema', $data->id)}}" method="Post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-8">
                                    <div class="form-group">
                                        <label>Nome da sistema do Equipamento</label>
                                        <input type="text" name="title" value="{{ $data->nome_sistema }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <a href="{{url('list_sistema')}}" class="btn btn-secondary">Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
